...
> 2026-05-20 追記: Remote-SSH 経由でこの破綻に遭遇したケースを別ドキュメント
> [`vscode-terminal.md`](./vscode-terminal.md) にまとめた。実測で
> `terminal.integrated.gpuAcceleration: "off"` を入れたところ再現しなく
> なったので、同症状が出る人はそちらを参照。
